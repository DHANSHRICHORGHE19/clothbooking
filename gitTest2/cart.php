...
<body>
    ...
    <?php   
  $cart_id=$_GET['cl_id'];
  $sql="Select * from clothes where cloth_id=$cart_id";
              ...
              <div class="col-lg-8">
                <div class="p-5">
                  <div class="d-flex justify-content-between align-items-center mb-5">
                    ...
                    <h6 class="mb-0 text-muted"><!--no of items--></h6>
                  </div>
                  <hr class="my-4">
                  ...
                  <div class="row mb-4 d-flex justify-content-between align-items-center">
                    <div class="col-md-2 col-lg-2 col-xl-2">
                      <!-- <img
                        ...
                        <img src="<?php echo $cloth_img ?>" class="img-fluid rounded-3" alt="Cotton T-shirt">
                    </div>
                    <div class="col-md-3 col-lg-3 col-xl-3">
                      <h6 class="text-muted"><?php echo $cloth_category; ?></h6>
                      <h6 class="text-black mb-0"><?php echo $cloth_name; ?></h6>
                    </div>
                    ...
                    <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                      <h6 class="mb-0"><?php echo $cloth_price; ?></h6>
                    </div>
